import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, n as composeRefs, R as React2, k as useComposedRefs, o as reactDomExports, p as React, q as ReactDOM, a as cn, b as Button, s as buttonVariants, d as Skeleton, B as Badge } from "./index-rhh0vFVk.js";
import { I as Input } from "./input-DQY78B54.js";
import { L as Label, T as Textarea, u as ue } from "./index-BTpX0P5C.js";
import { C as CATEGORIES, X, u as useProducts, f as useAddProduct, g as useUpdateProduct, h as useDeleteProduct } from "./useQueries-fHUPB9z9.js";
...
function toFormValues(product) {
  return {
    ...
    category: (product == null ? void 0 : product.category) ?? CATEGORY_OPTIONS[0],
    imageUrl: (product == null ? void 0 : product.imageUrl) ?? "",
    available: (product == null ? void 0 : product.available) ?? true,
...
function ProductForm({
  ...
  const [form, setForm] = reactExports.useState(toFormValues(initial));
    ...
    "form",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "prod-name", children: "اسم المنتج" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              id: "prod-name",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "prod-desc", children: "الوصف" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Textarea,
            {
              id: "prod-desc",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "prod-price", children: "السعر (ريال)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                id: "prod-price",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "prod-stock", children: "المخزون" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                id: "prod-stock",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "prod-category", children: "الفئة" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Select,
            {
              ...
              disabled: isPending,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { id: "prod-category", "data-ocid": "product.category_select", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "اختر الفئة" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: CATEGORY_OPTIONS.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: cat, children: cat }, cat)) })
              ]
            }
          ),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "prod-image", children: "رابط الصورة" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              id: "prod-image",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "prod-available", className: "cursor-pointer", children: "متاح للبيع" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 pt-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              children: isPending ? "جاري الحفظ..." : isEditing ? "حفظ التعديلات" : "إضافة المنتج"
            }
          ),
...
function ProductRow({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      "data-ocid": `products.item.${index2}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-md overflow-hidden shrink-0 bg-muted", children: product.imageUrl ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
        ...
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx(Package, { className: "w-6 h-6 m-3 text-muted-foreground" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-sm text-foreground truncate", children: product.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-xs shrink-0", children: product.category }),
            !product.available && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "destructive", className: "text-xs shrink-0", children: "غير متاح" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mt-0.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary font-semibold text-sm", children: formatPrice(product.price) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1 shrink-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              "data-ocid": `products.edit_button.${index2}`,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              "data-ocid": `products.delete_button.${index2}`,
...
function ProductsManager() {
  ...
  function handleAdd(input) {
    addProduct.mutate(input, {
      onSuccess: () => {
        ue.success("تم إضافة المنتج بنجاح");
        setShowAddDialog(false);
      },
      onError: () => ue.error("حدث خطأ أثناء الإضافة")
    });
  }
  function handleEdit(input) {
    ...
    updateProduct.mutate(
      ...
      {
        onSuccess: () => {
          ue.success("تم تحديث المنتج بنجاح");
          setEditingProduct(null);
        },
        onError: () => ue.error("حدث خطأ أثناء التحديث")
      }
    );
  }
  function handleDelete() {
    ...
    deleteProduct.mutate(deletingProduct.id, {
      onSuccess: () => {
        ue.success("تم حذف المنتج بنجاح");
        setDeletingProduct(null);
      },
      onError: () => ue.error("حدث خطأ أثناء الحذف")
    });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { dir: "rtl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: isLoading ? "..." : `${products.length} منتج` }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
          type: "button",
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "w-4 h-4 ml-1.5" }),
            "إضافة منتج"
          ]
        }
      )
    ] }),
    isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: [1, 2, 3, 4].map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-16 w-full rounded-lg" }, n)) }) : products.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "flex flex-col items-center justify-center py-16 text-center",
        "data-ocid": "products.empty_state",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Package, { className: "w-12 h-12 text-muted-foreground mb-3 opacity-40" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground mb-1", children: "لا توجد منتجات بعد" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mb-4", children: "ابدأ بإضافة منتجاتك الآن" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              type: "button",
    ...
    ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", "data-ocid": "products.list", children: products.map((product, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      ProductRow,
      {
        product,
        index: i + 1,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: showAddDialog, onOpenChange: setShowAddDialog, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      DialogContent,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "text-right", children: "إضافة منتج جديد" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ProductForm,
            {
              onSubmit: handleAdd,
      ...
      Dialog,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          DialogContent,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "text-right", children: "تعديل المنتج" }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      AlertDialog,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogContent, { dir: "rtl", "data-ocid": "products.delete.dialog", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTitle, { className: "text-right", children: "تأكيد الحذف" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogDescription, { className: "text-right", children: [
              "هل أنت متأكد أنك تريد حذف منتج",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: deletingProduct == null ? void 0 : deletingProduct.name }),
              "؟ لا يمكن التراجع عن هذا الإجراء."
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogFooter, { className: "flex-row-reverse gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              AlertDialogAction,
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogCancel, { "data-ocid": "products.delete.cancel_button", children: "إلغاء" })
          ] })
        ] })
      }
    )
